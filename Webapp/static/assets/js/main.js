...
let stateArray = ['Puerto Rico', 'Virgin Islands', 'Massachusetts', 'Connecticut',
...
'Maryland', 'Missouri', 'District of Columbia']
...
//       .then(data => {
//           // Assuming the Flask response contains a field named 'result'
//           document.getElementById('predictionResult').innerHTML = `Predicted Price: $${data.result}`;
//       })
